...
for folder in ~/Dropbox/{Archive,backups,cheat-sheets,conferences,configs,cv,finances,how-tos,icons,lectures,manuals,master-thesis,papers,personal,portfolio,presentations,project-stratocaster,project-hackintosh,ricardo,scores,software,teaching,tolino,travel-docs,wish-cards}; do
    dname=${folder##*/}

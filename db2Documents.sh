...
for folder in ~/Dropbox/{cheat-sheets,conferences,configs,cv,finances,lectures,manuals,master-thesis,papers,personal,presentations,research,scores,teaching,tolino,travel-docs}; do
    dname=${folder##*/}

...
*** Dev tools
    ...
    #+begin_src shell
      sudo pacman -S emacs vim base-devel gdb cmake docker pyenv ghc ghc-static cuda cuda-tools cudnn rust rust-analyzer ruby rubygems jenv jdk-openjdk jdk8-openjdk texlive-most texlive-lang gobject-introspection tk
    #+end_src

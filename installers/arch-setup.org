...
*** System tools
    Bash tab completion, xorg utilities, and system tray applets
    #+begin_src shell
      sudo pacman -S bash-completion man-db xdotool xscreensaver network-manager-applet blueman volumeicon
    #+end_src
...
*** Dev tools
    ...
    #+begin_src shell
      sudo pacman -S emacs vim ghc ghc-static rust ruby rubygems texlive-most texlive-lang
    #+end_src

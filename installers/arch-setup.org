...
*** Backup utilities
    ...
    So, these days I'm manually backing up my subvolumes. For more
    infos have a look at my dotfiles/bin/btrsnap script.
...
*** Networking tools
    VPN, tools for network discovery and security auditing
    #+begin_src shell
      sudo pacman -S firewalld fail2ban wireguard-tools nmap
    #+end_src
...
*** TODO LAMP/LEMP stack
    ...
    Install PHP
    #+begin_src shell
      sudo pacman -S php php-gd php-cgi php-fpm php-intl
    #+end_src

...
*** Dev tools
    ...
    #+begin_src shell
      sudo pacman -S emacs vim cmake docker pyenv ghc ghc-static rust ruby rubygems texlive-most texlive-lang gobject-introspection tk
    #+end_src
...
*** Virtualization
    ...
    #+begin_src shell
      sudo pacman -S virt-manager virt-viewer qemu qemu-arch-extra edk2-ovmf vde2 ebtables dnsmasq dmidecode bridge-utils openbsd-netcat

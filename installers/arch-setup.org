...
*** Dev tools
    Languages: lisp, haskell, cuda, rust, ruby, LaTeX
    #+begin_src shell
      sudo pacman -S emacs vim base-devel gdb cmake docker pyenv ghc ghc-static cuda cuda-tools cudnn rust ruby rubygems texlive-most texlive-lang gobject-introspection tk
    #+end_src
...
*** Networking tools
    ...
    #+begin_src shell
      sudo pacman -S ethtool wol nfs-utils samba sshfs rclone firewalld fail2ban nginx dnsmasq wireguard-tools nmap
    #+end_src
...
*** Nextcloud
    ...
    This enables you to mount your Nextcloud files folder in your
    file system table (~/etc/fstab~):
    #+begin_src shell
      davs://nextcloud.home/remote.php/dav/files/phdenzel/
    #+end_src

...
*** Dev tools
    ...
    #+begin_src shell
      sudo pacman -S emacs vim base-devel cmake docker pyenv ghc ghc-static cuda cuda-tools cudnn rust ruby rubygems texlive-most texlive-lang gobject-introspection tk
    #+end_src
...
*** Networking tools
    ...
    #+begin_src shell
      sudo pacman -S ethtool wol nfs-utils samba sshfs firewalld fail2ban nginx dnsmasq wireguard-tools nmap
    #+end_src

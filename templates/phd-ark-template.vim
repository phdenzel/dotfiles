" Name: #phd-ark-title.vim

set background=#phd-ark-mode
hi clear
...
let g:colors_name='#phd-ark-title'
set t_Co=256

let s:magenta = "#phd-ark-magenta"
let s:pink = "#phd-ark-pink"
let s:ruby = "#phd-ark-ruby"
let s:crimson = "#phd-ark-crimson"
let s:red = "#phd-ark-red"
let s:tiger = "#phd-ark-tiger"
let s:orange = "#phd-ark-orange"
let s:sand = "#phd-ark-sand"
let s:yellow = "#phd-ark-yellow"
let s:green = "#phd-ark-green"
let s:grass = "#phd-ark-grass"
let s:emerald = "#phd-ark-emerald"
let s:viridis = "#phd-ark-viridis"
let s:teal = "#phd-ark-teal"
let s:ocean = "#phd-ark-ocean"
let s:cyan = "#phd-ark-cyan"
let s:blue = "#phd-ark-blue"
let s:indigo = "#phd-ark-indigo"
let s:amethyst = "#phd-ark-amethyst"
let s:lilac = "#phd-ark-lilac"
let s:purple = "#phd-ark-purple"
let s:violet = "#phd-ark-violet"
let s:white = "#phd-ark-white"
let s:subtext0 = "#phd-ark-subtext0"
let s:subtext1 = "#phd-ark-subtext1"
let s:text = "#phd-ark-text"
let s:overlay2 = "#phd-ark-overlay2"
let s:overlay1 = "#phd-ark-overlay1"
let s:overlay0 = "#phd-ark-overlay0"
let s:surface2 = "#phd-ark-surface2"
let s:surface1 = "#phd-ark-surface1"
let s:surface0 = "#phd-ark-surface0"
let s:base = "#phd-ark-base"
let s:mantle = "#phd-ark-mantle"
let s:crust = "#phd-ark-crust"

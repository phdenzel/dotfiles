...
(defcustom phd-ark-flavor 'default
  "The flavor to use for the phd-ark theme.
Must be one of `default`, `dark`, or `light`."
...
(defcustom phd-ark-default-colors '((magenta   . "#phd-ark-default-magenta")
                                    (pink      . "#phd-ark-default-pink")
                                    (ruby      . "#phd-ark-default-ruby")
                                    (crimson   . "#phd-ark-default-crimson")
                                    (red       . "#phd-ark-default-red")
                                    (tiger     . "#phd-ark-default-tiger")
                                    (orange    . "#phd-ark-default-orange")
                                    (sand      . "#phd-ark-default-sand")
                                    (yellow    . "#phd-ark-default-yellow")
                                    (green     . "#phd-ark-default-green")
                                    (grass     . "#phd-ark-default-grass")
                                    (emerald   . "#phd-ark-default-emerald")
                                    (viridis   . "#phd-ark-default-viridis")
                                    (teal      . "#phd-ark-default-teal")
                                    (ocean     . "#phd-ark-default-ocean")
                                    (cyan      . "#phd-ark-default-cyan")
                                    (blue      . "#phd-ark-default-blue")
                                    (indigo    . "#phd-ark-default-indigo")
                                    (amethyst  . "#phd-ark-default-amethyst")
                                    (purple    . "#phd-ark-default-purple")
                                    (violet    . "#phd-ark-default-violet")
                                    (white     . "#phd-ark-default-white")
                                    (subtext0  . "#phd-ark-default-subtext0")
                                    (subtext1  . "#phd-ark-default-subtext1")
                                    (text      . "#phd-ark-default-text")
                                    (overlay2  . "#phd-ark-default-overlay2")
                                    (overlay1  . "#phd-ark-default-overlay1")
                                    (overlay0  . "#phd-ark-default-overlay0")
                                    (surface2  . "#phd-ark-default-surface2")
                                    (surface1  . "#phd-ark-default-surface1")
                                    (surface0  . "#phd-ark-default-surface0")
                                    (base      . "#phd-ark-default-base")
                                    (mantle    . "#phd-ark-default-mantle")
                                    (crust     . "#phd-ark-default-crust"))
  "Colors used for phd-ark default."
  :tag "Default Colors"
...
(defcustom phd-ark-dark-colors '((magenta   . "#phd-ark-dark-magenta")
                                 (pink      . "#phd-ark-dark-pink")
                                 (ruby      . "#phd-ark-dark-ruby")
                                 (crimson   . "#phd-ark-dark-crimson")
                                 (red       . "#phd-ark-dark-red")
                                 (tiger     . "#phd-ark-dark-tiger")
                                 (orange    . "#phd-ark-dark-orange")
                                 (sand      . "#phd-ark-dark-sand")
                                 (yellow    . "#phd-ark-dark-yellow")
                                 (green     . "#phd-ark-dark-green")
                                 (grass     . "#phd-ark-dark-grass")
                                 (emerald   . "#phd-ark-dark-emerald")
                                 (viridis   . "#phd-ark-dark-viridis")
                                 (teal      . "#phd-ark-dark-teal")
                                 (ocean     . "#phd-ark-dark-ocean")
                                 (cyan      . "#phd-ark-dark-cyan")
                                 (blue      . "#phd-ark-dark-blue")
                                 (indigo    . "#phd-ark-dark-indigo")
                                 (amethyst  . "#phd-ark-dark-amethyst")
                                 (purple    . "#phd-ark-dark-purple")
                                 (violet    . "#phd-ark-dark-violet")
                                 (white     . "#phd-ark-dark-white")
                                 (subtext0  . "#phd-ark-dark-subtext0")
                                 (subtext1  . "#phd-ark-dark-subtext1")
                                 (text      . "#phd-ark-dark-text")
                                 (overlay2  . "#phd-ark-dark-overlay2")
                                 (overlay1  . "#phd-ark-dark-overlay1")
                                 (overlay0  . "#phd-ark-dark-overlay0")
                                 (surface2  . "#phd-ark-dark-surface2")
                                 (surface1  . "#phd-ark-dark-surface1")
                                 (surface0  . "#phd-ark-dark-surface0")
                                 (base      . "#phd-ark-dark-base")
                                 (mantle    . "#phd-ark-dark-mantle")
                                 (crust     . "#phd-ark-dark-crust"))
...
(defcustom phd-ark-light-colors '((magenta   . "#phd-ark-light-magenta")
                                  (pink      . "#phd-ark-light-pink")
                                  (ruby      . "#phd-ark-light-ruby")
                                  (crimson   . "#phd-ark-light-crimson")
                                  (red       . "#phd-ark-light-red")
                                  (tiger     . "#phd-ark-light-tiger")
                                  (orange    . "#phd-ark-light-orange")
                                  (sand      . "#phd-ark-light-sand")
                                  (yellow    . "#phd-ark-light-yellow")
                                  (green     . "#phd-ark-light-green")
                                  (grass     . "#phd-ark-light-grass")
                                  (emerald   . "#phd-ark-light-emerald")
                                  (viridis   . "#phd-ark-light-viridis")
                                  (teal      . "#phd-ark-light-teal")
                                  (ocean     . "#phd-ark-light-ocean")
                                  (cyan      . "#phd-ark-light-cyan")
                                  (blue      . "#phd-ark-light-blue")
                                  (indigo    . "#phd-ark-light-indigo")
                                  (amethyst  . "#phd-ark-light-amethyst")
                                  (purple    . "#phd-ark-light-purple")
                                  (violet    . "#phd-ark-light-violet")
                                  (white     . "#phd-ark-light-white")
                                  (subtext0  . "#phd-ark-light-subtext0")
                                  (subtext1  . "#phd-ark-light-subtext1")
                                  (text      . "#phd-ark-light-text")
                                  (overlay2  . "#phd-ark-light-overlay2")
                                  (overlay1  . "#phd-ark-light-overlay1")
                                  (overlay0  . "#phd-ark-light-overlay0")
                                  (surface2  . "#phd-ark-light-surface2")
                                  (surface1  . "#phd-ark-light-surface1")
                                  (surface0  . "#phd-ark-light-surface0")
                                  (base      . "#phd-ark-light-base")
                                  (mantle    . "#phd-ark-light-mantle")
                                  (crust     . "#phd-ark-light-crust"))
